...
class TaskListener(TaskConfig):
    ...
    async def on_download_complete(self):
        ...
        if await is_video(up_path):
            ...
            # === [FIXED] Universal Adaptive Split + Rich UI with Navigation ===
            from bot.helper.utilities.universal_split import universal_split_if_needed
            import os
            from time import strftime

            split_files = await sync_to_async(universal_split_if_needed, up_path)
